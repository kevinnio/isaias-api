...
<tr>
    ...
    <td style="font-size:10px;text-align:left;"><b></b><BR/></td>
</tr>
<tr bgcolor="#fcc10f">
...
<tr bgcolor="#fcc10f">
    ...
    <td style="font-size:10px;text-align:center;border: 1px solid black;height:18px;line-height:20px;"><b>DEDUCIBLE ROBO</b></td>
    <td style="font-size:10px;text-align:center;border: 1px solid black;height:18px;line-height:20px;"><b>DEMORAS</b></td>
    <td style="font-size:10px;text-align:center;border: 1px solid black;height:18px;line-height:20px;"><b>LIMPIEZA EXTRAORDINARIA</b></td>
</tr>
</table>
</td></tr></table>
<table>
<tr>
    ...
    <td style="font-size:10px;text-align:center;height:18px;line-height:20px;"><b>{$row["DeducibleRobo"]}%</b><BR/></td>
    <td style="font-size:10px;text-align:center;height:18px;line-height:20px;"><b>{$row["Demoras"]}USD</b><BR/></td>
    <td style="font-size:10px;text-align:center;height:18px;line-height:20px;"><b>{$row["LimpiezaExtraordinaria"]}MXN</b><BR/></td>
</tr>
</table>
<table>
<tr>
    ...
    SIEMPRE Y CUANDO HAYA RECLAMACIONES POR CONTENEDOR DAÑADO, UNICAMENTE POR DERRAME DE ALGUN QUIMICO PELIGROSO, ACEITE O GRASAS A CONSECUENCIA DE UN ACCIDENTE O MALA MANIOBRA Y SIEMPRE Y CUANDO HAYA RECLAMACION POR CONTENEDOR DAÑADO
    </td>
</tr>
</table>
<table>
<tr bgcolor="#fcc10f"><BR/>
