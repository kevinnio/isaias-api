...
?>" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4"><input type="text" placeholder="ej: ABCD1234567  sin caracteres ( - , . @)" name="contenedor1" class="form-control m-b" required title="El formato debe tener 4 letras may̼sculas y 7 n̼meros" maxlength="11"></div>

                                <label class="col-sm-2 control-label">Contenedor 2</label>
                                <div class="col-sm-4"><input type="text" placeholder="ej: ABCD1234567  sin caracteres ( - , . @)" name="contenedor2" class="form-control m-b" required title="El formato debe tener 4 letras may̼sculas y 7 n̼meros" maxlength="11"></div>
